...
<audio class="plyr" controls>
  <source src="../_static/audio/Chapter03_motion-along-1D__3-4-motion-with-constant-acceleration.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>
...
<audio class="plyr" controls>
  <source src="../_static/audio/Chapter03_motion-along-1D__3-5-free-fall.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>
...
<audio class="plyr" controls>
  <source src="../_static/audio/Chapter03_motion-along-1D__3-6-finding-velocity-and-displacement-from-acceleration.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>
