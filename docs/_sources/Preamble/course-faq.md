...
2. A brief **strategy** (what ideas you’re using and why)
3. The **math**, written in sentences—not just equations
4. A **conclusion** explaining what the answer means physically
5. A small **Python check** (a calculation or a plot)

You’ll have a notebook template to follow.

##  Why do we have to use Python?

Python is just a **verification tool**.
You still have to solve the problem analytically first. Python is used to:
